# git-branch-helper Specification

## Purpose
Define the git helper that normalizes free text into a branch name and creates it.
...
- The category prefix MUST be one of `feature`, `bugfix`, `hotfix`, `chore`, or `refactor`
- The ticket number MUST match `[a-z]+-[0-9]+`
- Remaining tokens form the slug in lowercase joined with hyphens
